...
-- Dumping data for table orderbid.bid: ~5 rows (approximately)
...
INSERT INTO `bid` (`ID`, `BID_AMOUNT`, `BID_QTY`, `BID_TIME`, `USER`, `ORDER_NO`, `STATUS`) VALUES
	...
	(5, 18.00, 0, '2016-03-30 21:27:17', '3', 'A123445', 'A');
...
-- Dumping data for table orderbid.bid_sessions: ~21 rows (approximately)
...
-- Dumping data for table orderbid.pltorder: ~5 rows (approximately)
...
INSERT INTO `pltorder` (`ID`, `ADDITIONAL_FIELDS`, `SHIPMENT_DATE`, `ITEM_SYMBOL`, `DELIVERY_DATE`, `DEST_PIN`, `DEST_ADDRESS`, `LAST_MODIFIEDTIME`, `ORDER_BID_EXPIRYTIME`, `ORDER_DATE`, `ORDER_NO`, `PRIORITY`, `ASK_QUANTITY`, `SOURCE_ADDRESS`, `STATUS`, `UUID`, `SOURCE_PIN`, `COMPANY_ID`, `CREATED_BY`, `UPDATED_BY`, `ASK_RATE`, `WEIGHT`, `rowCount`) VALUES
	(1, 'gift', '2016-03-27 12:19:26', 'test', '2016-03-27 12:19:34', 411021, 'jalgaon', '2016-03-27 12:18:53', '2016-03-27 12:19:37', '2016-03-27 12:18:53', '1.0', 'S', 10, 'A123456', 'A', '1.0', 411038, 2, 2, 2, 34, 10, NULL),
	(2, 'gift', '2016-03-27 12:19:27', 'test', '2016-03-27 12:19:35', 411022, 'jalgaon', '2016-03-27 12:18:53', '2016-03-27 12:19:38', '2016-03-27 12:18:53', '2.0', 'S', 10, 'B123457', 'A', '2.0', 411038, 2, 2, 2, 56, 3, NULL),
	...
	(11, 'gift', '2016-02-22 00:00:00', '1.0', '2016-02-22 00:00:00', 411038, 'C-17, Shivnagari, Kothrud, Pune', '2016-04-04 22:10:07', NULL, '2016-04-04 22:10:07', 'A123456', 'N', 10, 'Bhugaon MIDC, Bhugan, Pune', 'A', '1.0', 411032, 2, 2, 2, 125, 10, NULL),
	(12, 'gift', '2016-02-22 00:00:00', '2.0', '2016-02-22 00:00:00', 411023, 'C-17, Shivnagari, Kothrud, Pune', '2016-04-04 22:10:08', NULL, '2016-04-04 22:10:08', 'B123457', 'N', 10, 'Bhugaon MIDC, Bhugan, Pune', 'A', '2.0', 411030, 2, 2, 2, 132, 12, NULL);
...
-- Dumping data for table orderbid.rate_card: ~1 rows (approximately)
...
-- Dumping data for table orderbid.tariff: ~20 rows (approximately)
/*!40000 ALTER TABLE `tariff` DISABLE KEYS */;
INSERT INTO `tariff` (`ID`, `CHARGE`, `PINCODE`, `RATE_CARD_ID`, `AREA`) VALUES
	(1, 11.00, 411021, 1, 'Bavdhan'),
	(2, 12.00, 411022, 1, 'Bhugaon'),
	(3, 13.00, 411023, 1, 'Kothrud'),
	(4, 14.00, 411024, 1, 'Camp'),
	(5, 15.00, 411025, 1, 'Vishrantwadi'),
	(6, 16.00, 411026, 1, 'Pune Station'),
	(7, 17.00, 411027, 1, 'Hadapsar'),
	(8, 18.00, 411028, 1, 'Kothrud depo'),
	(9, 19.00, 411029, 1, 'MIT college'),
	(10, 20.00, 411030, 1, 'Yerwada'),
	(11, 21.00, 411031, 1, 'Vimannagar'),
	(12, 22.00, 411032, 1, 'Pirangut'),
	(13, 23.00, 411033, 1, 'Pimpale Saudagar'),
	(14, 24.00, 411034, 1, 'Pimpale nilakh'),
	(15, 25.00, 411035, 1, 'Chinchwad'),
	(16, 26.00, 411036, 1, 'Pimpri'),
	(17, 27.00, 411037, 1, 'Sangavi'),
	(18, 28.00, 411038, 1, 'Nana peth'),
	(19, 29.00, 411039, 1, 'Shivajinagar'),
	(20, 30.00, 411040, 1, 'Warje');
...
-- Dumping data for table orderbid.user: ~6 rows (approximately)
...
-- Dumping data for table orderbid.watches: ~2 rows (approximately)
